...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    private RowData[] itemsData;

    public MyAdapter(RowData[] itemsData) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemLayoutView) {
            ...
            txtViewTitle = (TextView) itemLayoutView.findViewById(R.id.tvMainMenu);
            //imgViewIcon = (ImageView) itemLayoutView.findViewById(R.id.ivMainMenu);
        }
    }
